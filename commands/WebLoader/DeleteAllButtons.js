...
module.exports = {
    data: new SlashCommandBuilder()
        .setName("del-all-webloader-buttons")
        .setDescription("Delete all web loader buttons"),
    ...
    async execute(interaction) {
        ...
        fetch(`https://keyauth.win/api/seller/?sellerkey=${sellerkey}&type=delallbuttons`)
            .then(res => res.json())
            .then(json => {
                if (json.success) {

...
module.exports = {
    data: new SlashCommandBuilder()
        .setName("pause-application-subscriptions")
        .setDescription("Pause Subscription(s)")
    ...
    async execute(interaction) {
        ...
        fetch(`https://keyauth.win/api/seller/?sellerkey=${sellerkey}&type=pausesub&subscription=${sub}`)
            .then(res => res.json())
            .then(json => {
                if (json.success) {

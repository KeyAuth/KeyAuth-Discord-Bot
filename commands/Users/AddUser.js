  ...
  data: new SlashCommandBuilder()
    ...
    .addStringOption((option) =>
      option
        .setName("sub")
        .setDescription(
          "Name of subscription you want to assign user upon creation.",
        )
        .setDescriptionLocalizations({
          "en-US":
            "Name of subscription you want to assign user upon creation.",
    ...
    .addStringOption((option) =>
      option
        .setName("expires")
        .setDescription(
          "Number of days until the subscription assigned expires.",
        )
        .setDescriptionLocalizations({
    ...
    .addStringOption((option) =>
      option
        .setName("pass")
        .setDescription(
          "Password for user (optional) if not set, will be set later on login",
        )
        .setDescriptionLocalizations({
          "en-US":
            "Password for user (optional) if not set, will be set later on login",

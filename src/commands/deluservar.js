...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if(json.success)
        {
            interaction.editReply({ embeds: [new Discord.EmbedBuilder().setTitle(json.message).addFields('User variable deleted:', `\`${name}\``).setColor(Colors.Green).setTimestamp()], ephemeral: true})
        }
        else
        {

...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (subcommand === "licenses") {
            interaction.editReply({ embeds: [new Discord.EmbedBuilder().setTitle("Fetching Licenses...").setColor(Colors.Green).setTimestamp()], ephemeral: true })
            ...
            interaction.editReply({ embeds: [new Discord.EmbedBuilder().setTitle("Fetching Users...").setColor(Colors.Green).setTimestamp()], ephemeral: true })
            ...
            interaction.editReply({ embeds: [new Discord.EmbedBuilder().setTitle("Fetching Subs...").setColor(Colors.Green).setTimestamp()], ephemeral: true })
            ...
            interaction.editReply({ embeds: [new Discord.EmbedBuilder().setTitle("Fetching Chats...").setColor(Colors.Green).setTimestamp()], ephemeral: true })
            ...
            interaction.editReply({ embeds: [new Discord.EmbedBuilder().setTitle("Fetching Sessions...").setColor(Colors.Green).setTimestamp()], ephemeral: true })
            ...
            interaction.editReply({ embeds: [new Discord.EmbedBuilder().setTitle("Fetching Files...").setColor(Colors.Green).setTimestamp()], ephemeral: true })
            ...
            interaction.editReply({ embeds: [new Discord.EmbedBuilder().setTitle("Fetching Vars...").setColor(Colors.Green).setTimestamp()], ephemeral: true })
            ...
            interaction.editReply({ embeds: [new Discord.EmbedBuilder().setTitle("Fetching Blacklists...").setColor(Colors.Green).setTimestamp()], ephemeral: true })
            ...
            interaction.editReply({ embeds: [new Discord.EmbedBuilder().setTitle("Fetching Buttons...").setColor(Colors.Green).setTimestamp()], ephemeral: true })

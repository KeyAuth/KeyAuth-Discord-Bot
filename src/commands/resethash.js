...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if(json.success)
        {
            interaction.reply({ embeds: [new Discord.MessageEmbed().setTitle('Hash Successfully Reset!').addField('Reminder:', `You need to reset hash each time you compile loader.`).setColor("GREEN").setTimestamp()], ephemeral: true})
        }
        else
        {
